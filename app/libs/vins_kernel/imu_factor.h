...
#define LOG_TAG_IMUFACTOR "imu_factor.h"
#define LOGI(...)  __android_log_print(ANDROID_LOG_INFO, LOG_TAG_IMUFACTOR, __VA_ARGS__)
#define LOGE(...)  __android_log_print(ANDROID_LOG_ERROR, LOG_TAG_IMUFACTOR, __VA_ARGS__)
...
//delta_q = Qi.inverse() * Qj;
        ...
        if (jacobians)
        {
            ...
            {
                LOGI("numerical unstable in preintegration");
